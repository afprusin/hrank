package com.ohumbrella.hrank.algorithms.implementation.determiningdnahealth;
...
public class DeterminingDnaHealthOriginalImpl {
	...
	public static void main(String[] args) {
		for(int i = 0; i < 100; i++)
		new DeterminingDnaHealthOriginalImpl().runSolution();
	}
